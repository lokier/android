 ...
 *
 *   砸鸡蛋效果图
 * Created by lokierao on 2017/4/6.
 */
public class ThrowEggView extends View /*implements View.OnClickListener*/{
    ...
    public ThrowEggView(Context context) {
        super(context);
        intView(context);
    }

    public ThrowEggView(Context context, AttributeSet attrs) {
        super(context, attrs);
        intView(context);
    }

    public ThrowEggView(Context context, AttributeSet attrs, int defStyleAttr) {
