...
public class Rotatable implements View.OnTouchListener {
    ...
    private void swapViews(int rotation) {
        ...
        //ILog.i("xxxx","swapViews:" + rotation);
    ...
    public static class Builder {
         ...
         */
        public Builder sides(View frontViewId, View backViewId) {
            this.frontView = frontViewId;
            this.backView = backViewId;
            return this;
        }
