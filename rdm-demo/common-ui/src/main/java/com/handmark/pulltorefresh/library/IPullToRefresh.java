...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Demos the Pull-to-PullRefresh functionality to the user so that they are
	 * aware it is there. This could be useful when the user first opens your
	 * app, etc. The animation will only happen if the PullRefresh View (ListView,
	 * ScrollView, etc) is in a state where a Pull-to-PullRefresh could occur by a
	...
	/**
	 * Whether Pull-to-PullRefresh is enabled
	 * 
	 * @return enabled
	 */
	...
	/**
	 * Mark the current PullRefresh as complete. Will Reset the UI and hide the
	 * Refreshing View
	 */
	...
	/**
	 * Set the mode of Pull-to-PullRefresh that this view will use.
	 * 
	 ...
	 * 
	 * @param listener - Listener to be used when the Widget is set to PullRefresh
	 */
	 ...
	 * 
	 * @param scrollingWhileRefreshingEnabled - true if you want to isEnable
	 *            scrolling while refreshing
	 */
	public void setScrollingWhileRefreshingEnabled(boolean scrollingWhileRefreshingEnabled);

	/**
	 * A mutator to isEnable/disable whether the 'Refreshing' View should be
