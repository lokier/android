...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * @param enable Whether Pull-To-PullRefresh should be used
	 ...
	 * where the user can Pull to PullRefresh by scrolling from the end.
	 * 
	...
	/**
	 * Implemented by derived class to return whether the View is in a state
	 * where the user can Pull to PullRefresh by scrolling from the start.
	 * 
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		if (doScroll) {
			if (mShowViewWhileRefreshing) {
				...
				// Call PullRefresh Listener when the Scroll has finished
			...
			// We're not scrolling, so just call PullRefresh Listener now
			callRefreshListener();
		}
	}
	...
	public static enum Mode {
		...
		/**
		 * Disable all Pull-to-PullRefresh gesture and Refreshing handling
		 */
		DISABLED(0x0),
		...
		/**
		 * Disables Pull-to-PullRefresh gesture handling, but allows manually
		 * setting the PullRefresh state via
		...
		/**
		 * @return true if the mode permits Pull-to-PullRefresh
		 */
	...
	/**
	 * Simple Listener to listen for any callbacks to PullRefresh.
	 * 
	 * @author Chris Banes
	 */
	...
	/**
	 * An advanced version of the Listener to listen for callbacks to PullRefresh.
	...
	public static enum State {
		 ...
		 * with the Pull-to-PullRefresh function.
		 */
		RESET(0x0),
