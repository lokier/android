...
public abstract class BaseActivity extends FragmentActivity{
   ...
   /* public HashMap<String,Object> getParams(){
    ...
    protected boolean onCreateBefore(Bundle savedInstanceState){
        ILog.d(TAG,"onCreateBefore()");

        return true;
    }

    protected void onCreated(Bundle savedInstanceState) {
        ILog.d(TAG,"onCreateddddd()");
    }
    ...
    */
    ...
    final protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( !hasLaunchActivity  &&   launcherClass != null ) {
            //启动启动画面
            ILog.i(TAG,"Will start LuanchActivity first, the current activity : +" + getClass());
    ...
    public void onBackPressed() {
        ILog.d(TAG,"onBackPressed()");
        try {
            super.onBackPressed();
        } catch (Throwable t) {
            ILog.printStackTrace(t);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        ILog.i(TAG, "onActivityResult " + getClass().getSimpleName() + " :" + requestCode + "," + resultCode + "," + data);
    }
