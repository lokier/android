 ...
 */
public class BasePageIndicator<TYPE> extends HorizontalScrollView implements PageIndicator {

    public interface OnReachMostRightTabChangeListener {

        void onReachMostRightTabChange(BasePageIndicator tabPageIndicator, boolean reachMostRightTab);
    }
...
//        mTabLayout.setPadding(0, 0, DeviceUtils.dip2px(context, 20), 0);
    ...
    private  View onGetTabView(ViewGroup tabContainer, TYPE data){
        ...
        View tabView = LayoutInflater.from(BaseApp.get()).inflate(mTabRescoureId.intValue(), null);
        tabContainer.addView(tabView, new LinearLayout.LayoutParams(0, MATCH_PARENT, 1));
    ...
    private Runnable reachMostRightTabChangeRunnable = new Runnable() {
        ...
        public void run() {
            if (onReachMostRightTabChangeListener != null) {
                onReachMostRightTabChangeListener.onReachMostRightTabChange(BasePageIndicator.this, reachMostRightTab);
            }
        }
    };
